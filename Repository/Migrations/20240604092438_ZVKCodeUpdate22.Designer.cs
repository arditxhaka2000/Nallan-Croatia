...
namespace Repository.Migrations
{
    ...
    [Migration("20240604092438_ZVKCodeUpdate22")]
    partial class ZVKCodeUpdate22
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Data.AbroadVoter4Municipality", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.Property<int?>("ServiceConfigurationId")
                        .HasColumnType("int")
                        .HasColumnName("ServiceConfigurationId");
                    ...
                    b.ToTable("AbroadVoter4Municipalities");
                });
            ...
            modelBuilder.Entity("Data.Document", b =>
                {
                    ...
                    b.Property<bool>("IsRefusedByAbroadVoters")
                        .HasColumnType("bit");

                    b.Property<bool>("IsRefusedByPoliticalParty")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("Data.General.Embassy", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("DiplomaticRelationTypeId")
                        .HasColumnType("int")
                        .HasColumnName("DiplomaticRelationTypeId");
                    ...
                    b.HasIndex("DiplomaticRelationTypeId");
            ...
            modelBuilder.Entity("Data.General.Report", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("NameForShow")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("NameProcedure")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Data.General.ReportsRole", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Data.List", b =>
                {
                    ...
                    b.Property<int?>("ListTypeChildId")
                        .HasColumnType("int")
                        .HasColumnName("ListTypeChildId");
            ...
            modelBuilder.Entity("Data.PoliticalParty", b =>
                {
                    ...
                    b.Property<string>("CommentDiscussion")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("FileDiscussion")
                        .HasColumnType("nvarchar(max)");

                    b.Property<DateTime?>("FromDiscussion")
                        .HasColumnType("datetime2");
                    ...
                    b.Property<DateTime?>("ToDiscussion")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("Data.UserMunicipality", b =>
                {
                    b.Property<string>("UserId")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasKey("UserId", "MunicipalityId");
            ...
            modelBuilder.Entity("Data.VotersRegistration.AbroadVoter", b =>
                {
                    ...
                    b.Property<bool>("IsAbroadKosovoPostalBoox")
                        .HasColumnType("bit");

                    b.Property<bool>("IsDeleted")
                        .HasColumnType("bit");

                    b.Property<bool>("IsDiplomaticRepresented")
                        .HasColumnType("bit");

                    b.Property<bool>("IsKosovoPostalBoox")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("Data.VotersRegistration.AbroadVoterRefuseReason", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid?>("AbroadVoterId")
                        .HasColumnType("uniqueidentifier")
                        .HasColumnName("AbroadVoterId");
                    ...
                    b.ToTable("AbroadVoterRefuseReasons");
                });

            modelBuilder.Entity("Data.VotersRegistration.AbroadVoterUserAssignee", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<DateTime?>("Assignee2Date")
                        .HasColumnType("datetime2");

                    b.Property<DateTime>("AssigneeFromDate")
                        .HasColumnType("datetime2");
                    ...
                    b.ToTable("AbroadVoterUserAssignees");
                });
            ...
            modelBuilder.Entity("Data.ZVK.ConditionalBallotEnvelope", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("ConditionalBallotEnvelopes");
                });

            modelBuilder.Entity("Data.ZVK.ConditionalVoter", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid>("ConditionalBallotEnvelopeId")
                        .HasColumnType("uniqueidentifier")
                        .HasColumnName("ConditionalBallotEnvelopeId");
                    ...
                    b.HasIndex("ConditionalBallotEnvelopeId");
            ...
            modelBuilder.Entity("Data.AppUser", b =>
                {
                    ...
                    b.Property<bool>("HasChangeGeneratedPassword")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("Data.AbroadVoter4Municipality", b =>
                {
                    ...
                    b.HasOne("Data.ServiceConfiguration", "ServiceConfiguration")
                        .WithMany()
            ...
            modelBuilder.Entity("Data.General.Embassy", b =>
                {
                    b.HasOne("Data.General.Country", "Country")
                        .WithMany()
                    ...
                    b.HasOne("Data.List", "DiplomaticRelationType")
                        .WithMany()
                        .HasForeignKey("DiplomaticRelationTypeId");
                    ...
                    b.Navigation("DiplomaticRelationType");
            ...
            modelBuilder.Entity("Data.General.ReportsRole", b =>
                {
                    ...
                    b.HasOne("Data.General.Report", "Report")
                        .WithMany("ReportsRoles")
                        .HasForeignKey("ReportId");

                    b.HasOne("Data.ApplicationRole", "Role")
                        .WithMany("ReportsRoles")
            ...
            modelBuilder.Entity("Data.List", b =>
                {
                    ...
                    b.HasOne("Data.ListType", "ListTypeChild")
                        .WithMany()
                        .HasForeignKey("ListTypeChildId");
            ...
            modelBuilder.Entity("Data.VotersRegistration.AbroadVoter", b =>
                {
                    ...
                    b.HasOne("Data.AppUser", "Assignee")
                        .WithMany()
                    ...
                    b.HasOne("Data.General.Embassy", "Embassy")
                        .WithMany()
            ...
            modelBuilder.Entity("Data.VotersRegistration.AbroadVoterRefuseReason", b =>
                {
                    b.HasOne("Data.VotersRegistration.AbroadVoter", "AbroadVoter")
                        .WithMany("AbroadVoterRefuseReasons")
                        .HasForeignKey("AbroadVoterId");
                    ...
                    b.HasOne("Data.List", "RefuseReason")
                        .WithMany()
            ...
            modelBuilder.Entity("Data.VotersRegistration.SpecialNeedsVoters", b =>
                {
                    ...
                    b.HasOne("Data.List", "Institucion")
                        .WithMany()
            ...
            modelBuilder.Entity("Data.ZVK.ConditionalVoter", b =>
                {
                    b.HasOne("Data.ZVK.ConditionalBallotEnvelope", "ConditionalBallotEnvelope")
                        .WithMany()
                        .HasForeignKey("ConditionalBallotEnvelopeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.Navigation("ConditionalBallotEnvelope");
            ...
            modelBuilder.Entity("Data.General.Municipality", b =>
                {
                    ...
                    b.Navigation("UserMunicipalities");
                });
            ...
            modelBuilder.Entity("Data.VotersRegistration.AbroadVoter", b =>
                {
                    b.Navigation("AbroadVoterRefuseReasons");
