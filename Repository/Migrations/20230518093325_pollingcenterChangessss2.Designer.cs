...
namespace Repository.Migrations
{
    ...
    [Migration("20230518093325_pollingcenterChangessss2")]
    partial class pollingcenterChangessss2
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Data.CRC.DataResultsMatching", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("DataResultMatchings");
                });

            modelBuilder.Entity("Data.CRC.DataResultsMatchingCandidateDetailPP", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid?>("CandidateDetailPoliticPartyId")
                        .HasColumnType("uniqueidentifier")
                        .HasColumnName("CandidateDetailPoliticPartyId");
                    ...
                    b.Property<Guid?>("DataResultsMatchingFormId")
                        .HasColumnType("uniqueidentifier")
                        .HasColumnName("DataResultsMatchingFormId");
                    ...
                    b.HasIndex("CandidateDetailPoliticPartyId");

                    b.HasIndex("CreatedById");

                    b.HasIndex("DataResultsMatchingFormId");

                    b.HasIndex("DeletedById");

                    b.HasIndex("LastChangedById");

                    b.ToTable("DataResultsMatchingCandidateDetailPPs");
                });

            modelBuilder.Entity("Data.CRC.DataResultsMatchingCandidatePPEmployee", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid?>("DataResultsMatchingCandidateDetailPPId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("DataResultsMatchingCandidateDetailPPId");
                    ...
                    b.ToTable("DataResultsMatchingCandidatePPEmployees");
                });

            modelBuilder.Entity("Data.CRC.DataResultsMatchingForm", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");

                    b.Property<int>("AcceptedNrOfPapers")
                        .HasColumnType("int");

                    b.Property<int>("ConditionalDifferenceOfCNoSAndCNPIB")
                        .HasColumnType("int");

                    b.Property<int>("ConditionalNumberOfEnvelopeInsideBox")
                        .HasColumnType("int");

                    b.Property<int>("ConditionalNumberOfSignatures")
                        .HasColumnType("int");
                    ...
                    b.Property<int>("DamagedNumberOfPapers")
                        .HasColumnType("int");

                    b.Property<Guid?>("DataResultsMatchingId")
                        .HasColumnType("uniqueidentifier")
                        .HasColumnName("DataResultsMatchingId");
                    ...
                    b.Property<int>("DifferenceOfAnpTnp")
                        .HasColumnType("int");

                    b.Property<int>("DifferenceOfNoSAndNPIB")
                        .HasColumnType("int");

                    b.Property<int>("EmptyNumberOfPapers")
                        .HasColumnType("int");

                    b.Property<int>("InvalidNumberOfPapers")
                        .HasColumnType("int");
                    ...
                    b.Property<int>("NumberOfPapersInsideBox")
                        .HasColumnType("int");

                    b.Property<int>("NumberOfSignatures")
                        .HasColumnType("int");

                    b.Property<int>("TotalNumberOfEnpInpVnp")
                        .HasColumnType("int");

                    b.Property<int>("TotalNumberOfPapers")
                        .HasColumnType("int");

                    b.Property<int>("TotalValidNumberOfVotes")
                        .HasColumnType("int");

                    b.Property<int>("UnusedNumberOfPapers")
                        .HasColumnType("int");

                    b.Property<int>("ValidNumberOfPapers")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("DataResultsMatchingId");

                    b.HasIndex("DeletedById");

                    b.HasIndex("LastChangedById");

                    b.ToTable("DataResultsMatchingForms");
                });

            modelBuilder.Entity("Data.CRC.DataResultsMatchingPoliticalParty", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("DataResultsMatchingPoliticalParties");
                });

            modelBuilder.Entity("Data.CRC.StripeNr", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Data.DataResultsMatchingEmployee", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("DataResultsMatchingEmployees");
                });
            ...
            modelBuilder.Entity("Data.Document", b =>
                {
                    ...
                    b.Property<Guid?>("ObserverOrganizationPersonId")
                        .HasColumnType("uniqueidentifier")
                        .HasColumnName("ObserverOrganizationPersonId");
                    ...
                    b.HasIndex("ObserverOrganizationPersonId");
            ...
            modelBuilder.Entity("Data.General.CandidateOppositeGender", b =>
                {
                    ...
                    b.Property<Guid?>("MunicipalityConfigOppositeGenderId")
                        .HasColumnType("uniqueidentifier")
                        .HasColumnName("MunicipalityConfigOppositeGenderId");
                    ...
                    b.HasIndex("MunicipalityConfigOppositeGenderId");
            ...
            modelBuilder.Entity("Data.CRC.DataResultsMatchingCandidateDetailPP", b =>
                {
                    b.HasOne("Data.Certification.CandidateDetailPoliticParty", "CandidateDetailPoliticParty")
                        .WithMany()
                        .HasForeignKey("CandidateDetailPoliticPartyId");

                    b.HasOne("Data.AppUser", "CreatedBy")
                        .WithMany()
                        .HasForeignKey("CreatedById");

                    b.HasOne("Data.CRC.DataResultsMatchingForm", "DataResultsMatchingForm")
                        .WithMany("DataResultsMatchingCandidateDetailPPs")
                        .HasForeignKey("DataResultsMatchingFormId");
                    ...
                    b.Navigation("CandidateDetailPoliticParty");

                    b.Navigation("CreatedBy");

                    b.Navigation("DataResultsMatchingForm");
            ...
            modelBuilder.Entity("Data.CRC.DataResultsMatchingCandidatePPEmployee", b =>
                {
                    ...
                    b.HasOne("Data.CRC.DataResultsMatchingCandidateDetailPP", null)
                        .WithMany("DataResultsMatchingCaditatePPEmployees")
                        .HasForeignKey("DataResultsMatchingCandidateDetailPPId");
            ...
            modelBuilder.Entity("Data.CRC.DataResultsMatchingForm", b =>
                {
                    ...
                    b.HasOne("Data.CRC.DataResultsMatching", "DataResultsMatching")
                        .WithMany("DataResultsMatchingForms")
                        .HasForeignKey("DataResultsMatchingId");
                    ...
                    b.Navigation("DataResultsMatching");
            ...
            modelBuilder.Entity("Data.CRC.DataResultsMatchingPoliticalParty", b =>
                {
                    ...
                    b.HasOne("Data.CRC.DataResultsMatchingForm", "DataResultsMatchingForm")
                        .WithMany("DataResultsMatchingPoliticalParties")
                        .HasForeignKey("DataResultsMatchingFormId");
            ...
            modelBuilder.Entity("Data.DataResultsMatchingEmployee", b =>
                {
                    ...
                    b.HasOne("Data.CRC.DataResultsMatchingForm", "DataResultsMatchingForm")
                        .WithMany("DataResultsMatchingEmployees")
                        .HasForeignKey("DataResultsMatchingFormId");
            ...
            modelBuilder.Entity("Data.Document", b =>
                {
                    ...
                    b.HasOne("Data.AccreditationObservers.ObserverOrganizationPerson", "ObserverOrganizationPerson")
                        .WithMany()
                        .HasForeignKey("ObserverOrganizationPersonId");
                    ...
                    b.Navigation("ObserverOrganizationPerson");
            ...
            modelBuilder.Entity("Data.General.CandidateOppositeGender", b =>
                {
                    ...
                    b.HasOne("Data.General.MunicipalityConfigOppositeGender", "MunicipalityConfigOppositeGender")
                        .WithMany()
                        .HasForeignKey("MunicipalityConfigOppositeGenderId");
                    ...
                    b.Navigation("MunicipalityConfigOppositeGender");
                });
            ...
            modelBuilder.Entity("Data.CRC.DataResultsMatching", b =>
                {
                    b.Navigation("DataResultsMatchingForms");
            ...
            modelBuilder.Entity("Data.CRC.DataResultsMatchingCandidateDetailPP", b =>
                {
                    b.Navigation("DataResultsMatchingCaditatePPEmployees");
                });

            modelBuilder.Entity("Data.CRC.DataResultsMatchingForm", b =>
                {
                    b.Navigation("DataResultsMatchingCandidateDetailPPs");

                    b.Navigation("DataResultsMatchingEmployees");

                    b.Navigation("DataResultsMatchingPoliticalParties");

                    b.Navigation("StripeNrs");
                });
