        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NameAl = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ActionRoots", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HistoryParentId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Histories_AspNetUsers_DeletedById",
                        column: x => x.DeletedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Histories_AspNetUsers_LastChangedById",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Languages_AspNetUsers_LastChangedById",
                        column: x => x.LastChangedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                name: "UserActionRootRestRights",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    IdentityRoleId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    ActionRootId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserActionRootRestRights", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserActionRootRestRights_ActionRoots_ActionRootId",
                        column: x => x.ActionRootId,
                        principalTable: "ActionRoots",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserActionRootRestRights_AspNetUsers_CreatedById",
                        column: x => x.CreatedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_UserActionRootRestRights_AspNetUsers_DeletedById",
                        column: x => x.DeletedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_UserActionRootRestRights_AspNetUsers_LastChangedById",
                        column: x => x.LastChangedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserChangeHistories_AspNetUsers_CreatedById",
                        column: x => x.CreatedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_UserChangeHistories_AspNetUsers_DeletedById",
                        column: x => x.DeletedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_UserChangeHistories_AspNetUsers_LastChangedById",
                        column: x => x.LastChangedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_UserChangeHistories_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Localizations_AspNetUsers_CreatedById",
                        column: x => x.CreatedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Localizations_AspNetUsers_DeletedById",
                        column: x => x.DeletedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Localizations_AspNetUsers_LastChangedById",
                        column: x => x.LastChangedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Documents_AspNetUsers_LastChangedById",
                        column: x => x.LastChangedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DocumentTranslations_AspNetUsers_CreatedById",
                        column: x => x.CreatedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_DocumentTranslations_AspNetUsers_DeletedById",
                        column: x => x.DeletedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_DocumentTranslations_AspNetUsers_LastChangedById",
                        column: x => x.LastChangedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ActionRoots_CreatedById",
                table: "ActionRoots",
                column: "CreatedById");

            migrationBuilder.CreateIndex(
                name: "IX_ActionRoots_DeletedById",
                table: "ActionRoots",
                column: "DeletedById");

            migrationBuilder.CreateIndex(
                name: "IX_ActionRoots_LastChangedById",
                table: "ActionRoots",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_DefaultLanguageId",
                table: "AspNetUsers",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Documents_LastChangedById",
                table: "Documents",
                column: "LastChangedById");

            migrationBuilder.CreateIndex(
                name: "IX_DocumentTranslations_CreatedById",
                table: "DocumentTranslations",
                column: "CreatedById");

            migrationBuilder.CreateIndex(
                name: "IX_DocumentTranslations_DeletedById",
                table: "DocumentTranslations",
                column: "DeletedById");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DocumentTranslations_LastChangedById",
                table: "DocumentTranslations",
                column: "LastChangedById");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Histories_DeletedById",
                table: "Histories",
                column: "DeletedById");

            migrationBuilder.CreateIndex(
                name: "IX_Histories_LastChangedById",
                table: "Histories",
                column: "LastChangedById");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Languages_LastChangedById",
                table: "Languages",
                column: "LastChangedById");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Localizations_DeletedById",
                table: "Localizations",
                column: "DeletedById");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Localizations_LastChangedById",
                table: "Localizations",
                column: "LastChangedById");

            migrationBuilder.CreateIndex(
                name: "IX_UserActionRootRestRights_ActionRootId",
                table: "UserActionRootRestRights",
                column: "ActionRootId");

            migrationBuilder.CreateIndex(
                name: "IX_UserActionRootRestRights_CreatedById",
                table: "UserActionRootRestRights",
                column: "CreatedById");

            migrationBuilder.CreateIndex(
                name: "IX_UserActionRootRestRights_DeletedById",
                table: "UserActionRootRestRights",
                column: "DeletedById");

            migrationBuilder.CreateIndex(
                name: "IX_UserActionRootRestRights_IdentityRoleId",
                table: "UserActionRootRestRights",
                column: "IdentityRoleId");

            migrationBuilder.CreateIndex(
                name: "IX_UserActionRootRestRights_LastChangedById",
                table: "UserActionRootRestRights",
                column: "LastChangedById");

            migrationBuilder.CreateIndex(
                name: "IX_UserChangeHistories_CreatedById",
                table: "UserChangeHistories",
                column: "CreatedById");

            migrationBuilder.CreateIndex(
                name: "IX_UserChangeHistories_DeletedById",
                table: "UserChangeHistories",
                column: "DeletedById");

            migrationBuilder.CreateIndex(
                name: "IX_UserChangeHistories_LastChangedById",
                table: "UserChangeHistories",
                column: "LastChangedById");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_ActionRoots_AspNetUsers_CreatedById",
                table: "ActionRoots",
                column: "CreatedById",
                principalTable: "AspNetUsers",
                principalColumn: "Id");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_ActionRoots_AspNetUsers_DeletedById",
                table: "ActionRoots",
                column: "DeletedById",
                principalTable: "AspNetUsers",
                principalColumn: "Id");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_ActionRoots_AspNetUsers_LastChangedById",
                table: "ActionRoots",
                column: "LastChangedById",
                principalTable: "AspNetUsers",
                principalColumn: "Id");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_AspNetUsers_Languages_DefaultLanguageId",
                table: "AspNetUsers",
                column: "DefaultLanguageId",
                principalTable: "Languages",
                principalColumn: "Id");
