...
namespace Repository
{
    public class Repository<T> : IRepository<T> where T : BaseEntity
    {
        ...
        public IList<T> Get(Expression<Func<T, bool>> filter = null, Func<IQueryable<T>, IOrderedQueryable<T>> orderBy = null, IEnumerable<string> includeProperties = null)
        {
        ...
        public IList<T> GetAsNoTracking(Expression<Func<T, bool>> filter = null, Func<IQueryable<T>, IOrderedQueryable<T>> orderBy = null, IEnumerable<string> includeProperties = null)
        {
            IQueryable<T> query = this.entities.Where(x => !x.IsDeleted);
          ...
          IEnumerable<string> includeProperties = null)
        {
            ...
            return orderBy != null ? orderBy(query).AsNoTracking().FirstOrDefault() : query.AsNoTracking().FirstOrDefault();
        }

        public T GetSingleWithTracking(
         Expression<Func<T, bool>> filter = null,
         Func<IQueryable<T>, IOrderedQueryable<T>> orderBy = null,
         IEnumerable<string> includeProperties = null)
        {
