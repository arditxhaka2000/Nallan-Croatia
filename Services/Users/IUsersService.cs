...
namespace Services.Users
{
    public interface IUsersService
    {
        ...
        ApplicationRole GetRoleByUserName(string Username);

        //bool AddToMunicipalities(AppUser user, List<string> Municipalities);
        //bool AddToMunicipalities(AppUser user, string Municipality);
