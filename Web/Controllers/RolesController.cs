    ...
    public class RolesController : BaseController
    {
        ...
        public ActionResult Privilege(string Id)
        {
            ...
            RoleComplaintTabdb.ForEach(u =>
            {
                ...
                if (roletab != null)
                {
                    ...
                    u.HasWriteDateValidation = roletab.HasWriteDateValidation;
                    u.DateFromWriteValidation = roletab.DateFromWriteValidation;
                    u.DateToWriteValidation = roletab.DateToWriteValidation;
                }
            });
        ...
        private static void MappViewModelToModel(GetPrivilegesViewModel model, IQueryable<UserActionRootRestRight> UserComplaintTabRightDb)
        {
            foreach (var UserComplaintTabDb in UserComplaintTabRightDb)
            {
                ...
                UserComplaintTabDb.HasWriteDateValidation = UserComplaintTabViewModel.HasWriteDateValidation;
                UserComplaintTabDb.DateFromWriteValidation = UserComplaintTabViewModel.DateFromWriteValidation;
                UserComplaintTabDb.DateToWriteValidation = UserComplaintTabViewModel.DateToWriteValidation;
            }
        }
    }
}
